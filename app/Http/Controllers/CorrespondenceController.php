...
class CorrespondenceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($data,[
            'receiver' => 'required_without_all: depRoles,codegresa',
            'depRoles' => 'required_without_all: receiver,codegresa',
            'codegresa' => 'required_without_all: depRoles,receiver',
            'title' => 'required|string',
            'sender' => 'required|string', 
            'file' => 'mimes:pdf,png,jpg,jpeg,gif,docx,doc,xls,txt|max:2048',
        ]);
        if($validator->fails())
